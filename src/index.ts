...
export type { HeaderCategory, HeaderContext, HeaderInfo, HeaderStatus } from "./types.js";
export type {
...
// ---- Build / validate -------------------------------------------------------
export { generateHeadersFile, getRenderedLines, MAX_LINE_LENGTH, MAX_RULES } from "./build.js";
export { assertNoErrors, validateConfig } from "./validate.js";

// ---- Value builders -------------------------------------------------------
export { cacheControl, immutableAssetCacheControl, noCacheControl } from "./helpers/cache-control.js";
...
export { lockedDownPermissionsPolicy, permissionsPolicy } from "./helpers/permissions-policy.js";
export type { PermissionsPolicyAllowlist, PermissionsPolicyOptions } from "./helpers/permissions-policy.js";
 ...
 */
export function rule(path: string, headers: HeaderRule["headers"], comment?: string): HeaderRule {
...
export function buildHeadersFile(rules: HeaderRule[]): { content: string; issues: ValidationIssue[] } {
 ...
 */
export async function writeHeadersFile(config: CfHeadersConfig): Promise<WriteHeadersFileResult> {
