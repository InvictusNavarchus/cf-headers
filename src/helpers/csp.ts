...
const DIRECTIVE_NAMES: Record<keyof Omit<CspOptions, "reportTo" | "reportUri" | "upgradeInsecureRequests" | "blockAllMixedContent">, string> = {
...
export function csp(options: CspOptions): string {
  ...
  for (const [key, directive] of Object.entries(DIRECTIVE_NAMES) as [keyof typeof DIRECTIVE_NAMES, string][]) {
